module ApplicationHelper
  def sortable_table_header(title, column, path_method, **)
    content_tag(:th, class: "table__th") do
  ...
  def svg_icon(path_d)
    content_tag(:svg, xmlns: "http://www.w3.org/2000/svg", class: "ml-1 inline w-4 h-4", width: "10", height: "10", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor") do
